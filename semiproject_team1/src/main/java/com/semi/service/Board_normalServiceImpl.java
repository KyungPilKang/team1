...
@Service
public class Board_normalServiceImpl implements Board_normalService {
    ...
    public List<Board> getBoardList(int page, PageInfo pageInfo) throws Exception {
        int listCount = boardDAO.selectBoardCount_normal();
        ...
        return boardDAO.selectBoardList_normal(startrow);
    }
    ...
    public List<Board> getBoardList_viewsSort(int page, PageInfo pageInfo) throws Exception {
        ...
        pageInfo.setListCount(listCount);
        int startrow = (page - 1) * 10 + 1;
        return boardDAO.selectBoardList_normal_viewsSort(startrow);
    }
    ...
    public List<Board> getBoardList_replySort(int page, PageInfo pageInfo) throws Exception {
        ...
        pageInfo.setListCount(listCount);
        int startrow = (page - 1) * 10 + 1;
        return boardDAO.selectBoardList_normal_replySort(startrow);
    }
    ...
    public List<Board> getBoardList_likeSort(int page, PageInfo pageInfo) throws Exception {
        ...
        pageInfo.setListCount(listCount);
        int startrow = (page - 1) * 10 + 1;
        return boardDAO.selectBoardList_normal_likeSort(startrow);
    }

    @Override
    public List<Board> getBoardList_search_subject(int page, PageInfo pageInfo, Board board) throws Exception {
        int listCount = boardDAO.selectBoardCount_normal_subject(board.getBoard_keyword());
        int maxPage = (int) Math.ceil((double) listCount / 10);
        int startPage = ((int) ((double) page / 10 + 0.9) - 1) * 10 + 1;
        int endPage = startPage + 10 - 1;
        if (endPage > maxPage) endPage = maxPage;
        ...
        return boardDAO.selectBoardList_normal_search_subject(startrow,board.getBoard_keyword());
    }

    @Override
    public List<Board> getBoardList_search_nickname(int page, PageInfo pageInfo, Board board) throws Exception {
        int listCount = boardDAO.selectBoardCount_normal_nickname(board.getBoard_keyword());
        int maxPage = (int) Math.ceil((double) listCount / 10);
        int startPage = ((int) ((double) page / 10 + 0.9) - 1) * 10 + 1;
        int endPage = startPage + 10 - 1;
        if (endPage > maxPage) endPage = maxPage;
        ...
        int startrow = (page - 1) * 10 + 1;
        System.out.println("listCount : "+  listCount);
        return boardDAO.selectBoardList_normal_search_nickname(startrow,board.getBoard_keyword());
    }

    @Override
    public List<Board> getBoardList_search_content(int page, PageInfo pageInfo, Board board) throws Exception {
        int listCount = boardDAO.selectBoardCount_normal_content(board.getBoard_keyword());
        int maxPage = (int) Math.ceil((double) listCount / 10);
        int startPage = ((int) ((double) page / 10 + 0.9) - 1) * 10 + 1;
        int endPage = startPage + 10 - 1;
        if (endPage > maxPage) endPage = maxPage;
        ...
        int startrow = (page - 1) * 10 + 1;
        System.out.println("listCount : "+  listCount);
        return boardDAO.selectBoardList_normal_search_content(startrow,board.getBoard_keyword());
    }
