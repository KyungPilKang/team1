                ...
                <div class="col-lg-12">
                  ...
                  <div>
                    ...
                    <div class="progress progress-md">
                      <div class="progress-bar bg-success" role="progressbar" style="width: 100%" aria-valuenow="70"
                  ...
                  <div class="d-flex justify-content-center align-items-center">
                    <h4 class="card-title card-title-dash">선택하신 옵션은 다음과 같습니다</h4>
                  </div>
                  ...
                  <div class="list-wrapper">
                    <ul class="todo-list todo-list-rounded">
                      ...
                      <li class="d-block">
                        <div class="form-check w-100">
                          <label class="">
                            <input class="checkbox" type="checkbox"> 입력1
                          </label>
                        </div>
                      </li>
                      ...
                      <li class="d-block">
                        <div class="form-check w-100">
                          <label class="">
                            <input class="checkbox" type="checkbox"> 입력2
                          </label>
                        </div>
                      </li>
                      ...
                      <li class="d-block">
                        <div class="form-check w-100">
                          <label class="">
                            <input class="checkbox" type="checkbox"> 입력3
                          </label>
                        </div>
                      </li>
                      ...
                      <li class="d-block">
                        <div class="form-check w-100">
                          <label class="">
                            <input class="checkbox" type="checkbox"> 입력4
                          </label>
                        </div>
                      </li>
                      ...
                      <li class="d-block">
                        <div class="form-check w-100">
                          <label class="">
                            <input class="checkbox" type="checkbox"> 입력5
                          </label>
                        </div>
                      </li>
                      ...
                      <li class="border-bottom-0">
                        <div class="form-check w-100">
                          <label class="">
                            <input class="checkbox" type="checkbox"> 입력6
                          </label>
                        </div>
                      </li>
                    </ul>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                      <button type="submit" class="btn btn-primary me-2">취소</button>
                      <button type="submit" class="btn btn-primary me-2">매칭</button>
                    </div>
                  </div>
                </div>
              </div>
