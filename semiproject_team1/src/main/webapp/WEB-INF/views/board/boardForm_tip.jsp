              ...
              <ul class="list">
                ...
                <li><h6>LOL</h6>
                  <ul class="list">
                    ...
                    <li><a href="/boardlist_tip" style="color:#06e4f5">팁&노하우</a></li>
                  </ul>
                </li>
                <hr>
                <li><h6>COMMUNITY</h6>
