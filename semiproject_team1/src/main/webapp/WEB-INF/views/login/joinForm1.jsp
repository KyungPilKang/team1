...
<div style="padding-top: 10px;">
    ...
    <button class="btn btn-lg btn-primary" type="submit" style="border-color:white; float:center; width: 80%; color: black; background-color: grey; ">비동의</button>
</div>
<div style="width:50%; float:right;">    
<button class="btn btn-lg btn-primary" type="submit" style="float:center; width: 80%;">동의</button>
</div>
</div>    
  </form>
</main>
