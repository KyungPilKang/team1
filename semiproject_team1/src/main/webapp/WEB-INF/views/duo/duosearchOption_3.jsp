                ...
                <div class="col-lg-12">
                  <div>
                    ...
                    <div class="progress progress-md">
                      <div class="progress-bar bg-success" role="progressbar" style="width: 75%" aria-valuenow="70"
                  ...
                  <div class="d-flex justify-content-center align-items-center">
                    <h4 class="card-title card-title-dash">원하는 승률구간을 선택하세요</h4>
                  </div>
                    ...
                    <ul class="todo-list todo-list-rounded">
                      ...
                      <li class="d-block">
                        <div class="form-check w-100">
                          <label class="">
                            <input class="checkbox" type="checkbox"> 80% 이상
                          </label>
                        </div>
                      </li>
                      ...
                      <li class="d-block">
                        <div class="form-check w-100">
                          <label class="">
                            <input class="checkbox" type="checkbox"> 80% 미만 ~ 60% 이상
                          </label>
                        </div>
                      </li>
                      ...
                      <li class="d-block">
                        <div class="form-check w-100">
                          <label class="">
                            <input class="checkbox" type="checkbox"> 60% 미만 ~ 57% 이상
                          </label>
                        </div>
                      </li>
                      ...
                      <li class="d-block">
                        <div class="form-check w-100">
                          <label class="">
                            <input class="checkbox" type="checkbox"> 57% 미만 ~ 54% 이상
                          </label>
                        </div>
                      </li>
                      ...
                      <li class="d-block">
                        <div class="form-check w-100">
                          <label class="">
                            <input class="checkbox" type="checkbox"> 54% 미만 ~ 50% 이상
                          </label>
                        </div>
                      </li>
                      ...
                      <li class="border-bottom-0">
                        <div class="form-check w-100">
                          <label class="">
                            <input class="checkbox" type="checkbox"> 상관없음
                          </label>
                        </div>
                      </li>
