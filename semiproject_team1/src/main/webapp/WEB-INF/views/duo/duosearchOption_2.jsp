              ...
              <div class="row">
                <div class="col-lg-12">
                  ...
                  <div class="d-flex justify-content-center align-items-center">
                    <h4 class="card-title card-title-dash">원하는 티어를 선택하세요</h4>
                  </div>
                    ...
                    <ul class="todo-list todo-list-rounded">
                      ...
                      <li class="d-block">
                        <div class="form-check w-100">
                          <label class="">
                            <input class="checkbox" type="checkbox"> 다이아몬드I~II
                          </label>
                        </div>
                      </li>
                      ...
                      <li class="d-block">
                        <div class="form-check w-100">
                          <label class="">
                            <input class="checkbox" type="checkbox"> 다이아몬드III~IV
                          </label>
                        </div>
                      </li>
                      ...
                      <li class="d-block">
                        <div class="form-check w-100">
                          <label class="">
                            <input class="checkbox" type="checkbox"> 플래티넘
                          </label>
                        </div>
                      </li>
                      ...
                      <li class="d-block">
                        <div class="form-check w-100">
                          <label class="">
                            <input class="checkbox" type="checkbox"> 골드
                          </label>
                        </div>
                      </li>
                      ...
                      <li class="d-block">
                        <div class="form-check w-100">
                          <label class="">
                            <input class="checkbox" type="checkbox"> 실버
                          </label>
                        </div>
                      </li>
                      ...
                      <li class="border-bottom-0">
                        <div class="form-check w-100">
                          <label class="">
                            <input class="checkbox" type="checkbox"> 브론즈
                          </label>
                        </div>
                      </li>
